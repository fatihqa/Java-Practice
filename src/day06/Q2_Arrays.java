...
public class Q2_Arrays {
    public static void main(String[] args) {
        ...
        int [] integers;
        integers=new int[5];
        System.out.println(Arrays.toString(integers));  // Array 'in ilk hali
        ...
        //Soru= Ayse ile Fatma'nın yerini degistirelim

        String bosKova=isimler[0];
        isimler[0]=isimler[1];
        isimler[1]=bosKova;

        System.out.println("Yeni hai : "+Arrays.toString(isimler));
